const ProjectsData = [
  {
    id: 1,
    title: 'Lean',
    pcImage: 'works/lean/lean-pc.png',
    ...
    descriptionJp:
      'このプロジェクトは、少し高度なReactの使い方を学ぶために開発しました。framer motionやparallax effectなどについての理解が深まりました。 また、ショッピングカート機能も初めて実装しました！',
    languages: {
      html: true,
      css: true,
      js: true,
  ...
  },
  {
    ...
    descriptionEn:
      'I made a landing page for a real estate consultation service. I not only created the page, but also learned a lot about servers, file transfer, and other practical matters.',
    descriptionJp:
