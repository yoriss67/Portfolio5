    ...
    <div className="hero">
      ...
      <div className="hero_width">
        <div className={`hero_left `}>
          ...
          >
            <h1 className={` ${inViewH1 ? 'true' : 'false'}`} ref={refH1}>
              Hi, I'm Iori !
            </h1>
          </motion.div>

          <h3 className={` ${inViewH3 ? 'true' : 'false'}`} ref={refH3}>
            <motion.div
              initial={{ opacity: 0.3, y: '10vw' }}
              animate={inViewH1 ? { y: '0vw', opacity: 1, scale: 1 } : {}}
        ...
        <div className={`hero_right`}>
          <div
            className={`hero_right_p1 ${inView1 ? 'true' : 'false'}`}
            ref={ref1}
          >
            <motion.div
            ...
            >
              <p
                className={`hero_right_p toggleBox-en ${
                  isJapanese ? 'display-none' : ''
                }`}
              >
                As a self-taught learner, I continuously pursue new challenges
                and opportunities to sharpen my abilities.
              </p>
              <p
                className={`hero_right_p toggleBox-jp ${
                  isJapanese ? '' : 'display-none'
                }`}
              >
          ...
          <div
            className={`hero_right_p2 ${inView2 ? 'true' : 'false'}`}
            ref={ref2}
          >
            <motion.div
              initial={{ opacity: 0, y: '5vh' }}
              animate={inView2 ? { y: '0vw', opacity: 1, scale: 1 } : {}}
              transition={{ duration: 3, delay: 5.8 }}
            >
              <p
                className={`hero_right_p hero_right_p2 toggleBox-en ${
                  isJapanese ? 'display-none' : ''
                }`}
              >
              ...
              <p
                className={`hero_right_p hero_right_p2 toggleBox-jp ${
                  isJapanese ? '' : 'display-none'
                }`}
              >
          ...
          <div
            className={`hero_right_p3 ${inView3 ? 'true' : 'false'}`}
            ref={ref3}
          >
            <motion.div
              initial={{ opacity: 0, y: '5vh' }}
            ...
            >
              <p
                className={`hero_right_p hero_right_p3 toggleBox-en ${
                  isJapanese ? 'display-none' : ''
                }`}
              >
                Driven by curiosity and a desire for personal growth, I strive
                to turn insights into impactful actions.
              </p>
              <p
                className={`hero_right_p hero_right_p3 toggleBox-jp ${
                  isJapanese ? '' : 'display-none'
                }`}
              >
